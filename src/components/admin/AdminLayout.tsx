...
export default function AdminLayout() {
 ...
 <span className="text-fs-xs font-medium text-muted-foreground hidden sm:inline">Admin</span>
 </Link>
 ...
 {/* Scoped Suspense keeps sidebar + header mounted; only the content area
      shows a skeleton while the next admin route's lazy chunk loads. */}
 <Suspense fallback={<PageSkeleton layout="dashboard" withHeader={false} count={6} />}>
  <Outlet />
 </Suspense>
 </main>
 </div>
