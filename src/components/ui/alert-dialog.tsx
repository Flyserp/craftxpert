...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title ref={ref} className={cn("text-fs-lg font-semibold leading-tight tracking-tight", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description ref={ref} className={cn("text-fs-sm leading-snug text-muted-foreground", className)} {...props} />
));
